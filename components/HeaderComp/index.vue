            ...
            <div :class="menuOpen" class="header__menu menu">
                ...
                <nav class="menu__body">
                    ...
                    <div class="header__links">
                        <button class="header__link" @click="toUserProfile">
...
export default {
    ...
    computed: {
        ...
        ...mapGetters('user', ['userProfileName', 'userProfileId', 'getUserById']),
        userNameId() {
            return this.userProfileId
        },
        toTelegramChannel() {
            return this.userProfileId ? this.telegramChannelURL : null
        },
    },
    ...
    methods: {
        ...
        toUserProfile() {
            ...
            if (storageUser) {
                const getStorageUser = this.usersList.find((user) => {
                    return user.login === storageUser.login
                })
                if (getStorageUser) {
