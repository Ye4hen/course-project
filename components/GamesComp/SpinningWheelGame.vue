            ...
            <div class="wheel-wrapper">
                ...
                >
                    <div class="prize-list">
                        <div class="prize-item-wrapper" v-for="(item, index) in prizesList" :key="item.id">
                            <div
                                class="prize-item"
...
export default {
    ...
    computed: {
        ...
        gameWheelBG() {
            if (this.game.name === 'Snow Spin') {
                return 'snow-spin__bg'
            } else if (this.game.name === 'Golden Reels') {
    ...
    methods: {
        ...
        roll(resultIndex) {
            ...
            setTimeout(() => {
                ...
                } else if (this.result === 'X2') {
                    coinsToDecrement.amount = coinsToDecrement.amount * 2
                } else if (this.result === 'X3') {
                    coinsToDecrement.amount = coinsToDecrement.amount * 3
                } else if (this.result === 'X5') {
                    coinsToDecrement.amount = coinsToDecrement.amount * 5
                } else if (this.result === 'X10') {
